...
//   BEngine::Belog::Init();
//
//   BENGINE_PROFILE_BEGIN_SESSION("Startup", "HazelProfile-Startup.json");
//   auto app = BEngine::CreateApplication({argc, argv});
//   BENGINE_PROFILE_END_SESSION();
//
//   BENGINE_PROFILE_BEGIN_SESSION("Runtime", "HazelProfile-Runtime.json");
//   app->Run();
//   BENGINE_PROFILE_END_SESSION();
//
//   BENGINE_PROFILE_BEGIN_SESSION("Shutdown", "HazelProfile-Shutdown.json");
//   delete app;
//   BENGINE_PROFILE_END_SESSION();
// }
//
