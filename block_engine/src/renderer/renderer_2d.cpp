...
#include "block_engine/src/renderer/UI/msdf_data.h"
...
void Renderer2D::Init() {
  ...
  s_Data.QuadVertexBuffer = VertexBuffer::Create(
      BEngine::Renderer2DData::MaxVertices * sizeof(QuadVertex));
  ...
  s_Data.QuadVertexBufferBase =
      new QuadVertex[BEngine::Renderer2DData::MaxVertices];

  auto* quadIndices = new uint32_t[BEngine::Renderer2DData::MaxIndices];

  uint32_t offset = 0;
  for (uint32_t i = 0; i < BEngine::Renderer2DData::MaxIndices; i += 6) {
  ...
  Ref<IndexBuffer> quadIB =
      IndexBuffer::Create(quadIndices, BEngine::Renderer2DData::MaxIndices);
  ...
  s_Data.CircleVertexBuffer = VertexBuffer::Create(
      BEngine::Renderer2DData::MaxVertices * sizeof(CircleVertex));
  ...
  s_Data.CircleVertexBufferBase =
      new CircleVertex[BEngine::Renderer2DData::MaxVertices];

  // Lines
  s_Data.LineVertexArray = VertexArray::Create();

  s_Data.LineVertexBuffer = VertexBuffer::Create(
      BEngine::Renderer2DData::MaxVertices * sizeof(LineVertex));
  ...
  s_Data.TextVertexBuffer = VertexBuffer::Create(
      BEngine::Renderer2DData::MaxVertices * sizeof(TextVertex));
  ...
  int32_t samplers[BEngine::Renderer2DData::MaxTextureSlots];
...
void Renderer2D::Flush() {
  ...
  if (s_Data.TextIndexCount) {
    uint32_t dataSize = (uint32_t)((uint8_t*)s_Data.TextVertexBufferPtr -
                                   (uint8_t*)s_Data.TextVertexBufferBase);
...
/*void Renderer2D::DrawString(const std::string& string, Ref<Font> font, const
glm::mat4& transform, const TextParams& textParams, int entityID)
{
        ...
        const float spaceGlyphAdvance = fontGeometry.getGlyph('
')->getAdvance();
...
textParams.LineSpacing; continue;
                }
                ...
                if (character == ' ')
                {
                        ...
                        if (i < string.size() - 1)
                        {
                                ...
                                double dAdvance;
                                fontGeometry.getAdvance(dAdvance, character,
nextCharacter); advance = (float)dAdvance;
                        }
...
textParams.Kerning); continue;
                ...
                // render here
                s_Data.TextVertexBufferPtr->Position = transform *
glm::vec4(quadMin, 0.0f, 1.0f); s_Data.TextVertexBufferPtr->Color =
textParams.Color; s_Data.TextVertexBufferPtr->TexCoord = texCoordMin;
                s_Data.TextVertexBufferPtr->EntityID = entityID;
                s_Data.TextVertexBufferPtr++;

                s_Data.TextVertexBufferPtr->Position = transform *
glm::vec4(quadMin.x, quadMax.y, 0.0f, 1.0f); s_Data.TextVertexBufferPtr->Color =
textParams.Color; s_Data.TextVertexBufferPtr->TexCoord = { texCoordMin.x,
texCoordMax.y }; s_Data.TextVertexBufferPtr->EntityID = entityID;
                s_Data.TextVertexBufferPtr++;

                s_Data.TextVertexBufferPtr->Position = transform *
glm::vec4(quadMax, 0.0f, 1.0f); s_Data.TextVertexBufferPtr->Color =
textParams.Color; s_Data.TextVertexBufferPtr->TexCoord = texCoordMax;
                s_Data.TextVertexBufferPtr->EntityID = entityID;
                s_Data.TextVertexBufferPtr++;

                s_Data.TextVertexBufferPtr->Position = transform *
glm::vec4(quadMax.x, quadMin.y, 0.0f, 1.0f); s_Data.TextVertexBufferPtr->Color =
textParams.Color; s_Data.TextVertexBufferPtr->TexCoord = { texCoordMax.x,
texCoordMin.y }; s_Data.TextVertexBufferPtr->EntityID = entityID;
                s_Data.TextVertexBufferPtr++;
                ...
                if (i < string.size() - 1)
                {
                        ...
                        char nextCharacter = string[i + 1];
                        fontGeometry.getAdvance(advance, character,
nextCharacter);
...
void Renderer2D::DrawString(const std::string& string, const glm::mat4&
transform, const TextComponent& component, int entityID)
{
        DrawString(string, component.FontAsset, transform, { component.Color,
component.Kerning, component.LineSpacing }, entityID);
}*/
