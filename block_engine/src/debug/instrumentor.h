...
#define BENGINE_PROFILE 0
  ...
  #define BENGINE_PROFILE_BEGIN_SESSION(name, filepath) ::Hazel::Instrumentor::Get().BeginSession(name, filepath)
  #define BENGINE_PROFILE_END_SESSION() ::Hazel::Instrumentor::Get().EndSession()
  #define BENGINE_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Hazel::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
  ::Hazel::InstrumentationTimer timer##line(fixedName##line.Data)
  #define BENGINE_PROFILE_SCOPE_LINE(name, line) BENGINE_PROFILE_SCOPE_LINE2(name, line)
